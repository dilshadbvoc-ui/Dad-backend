...
const organisationSchema = new mongoose_1.default.Schema({
    ...
    // License Info
    subscription: {
        plan: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'SubscriptionPlan' },
        status: {
            type: String,
...
const Organisation = mongoose_1.default.models.Organisation || mongoose_1.default.model('Organisation', organisationSchema);
