...
const webFormSchema = new mongoose_1.default.Schema({
    ...
    fields: [{
            ...
            placeholder: String,
            defaultValue: mongoose_1.default.Schema.Types.Mixed,
...
const WebForm = mongoose_1.default.models.WebForm || mongoose_1.default.model('WebForm', webFormSchema);
